...
public class Twitter_cluster implements Serializable
{
    ...
    public Twitter_cluster(){
    	super();
    }
    
    // costruttore della classe 
    public Twitter_cluster(String tweet_ID,Integer cluster,String dateT,String hour,String username,String nickname, String biography, String tweet_content,String favs, String rts, String latitude, String longitude, String country, String place, String prof, int followers, int following, int listed,  String language, String url)
    { 
    ...
    public void setcluster(Integer tmp){
    	cluster = tmp;
    }
